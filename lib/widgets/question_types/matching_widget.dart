...
class _MatchingWidgetState extends State<MatchingWidget> {
  ...
  void initState() {
    super.initState();
    _matches = Map<String, String>.from(widget.initialAnswer ?? const {});
  }
  ...
  void _selectRight(String rightId) {
    if (!_interactive || _activeLeftId == null) return;
    setState(() {
      ...
      children: items.map((item) {
        ...
        return Padding(
          ...
          child: Material(
            ...
            child: InkWell(
              onTap: _interactive ? () => isLeft ? _selectLeft(id) : _selectRight(id) : null,
